...
const Book = (props) => {
    ...
    const redirectToList = Routes.Books.path;
        ...
        <div>
            ...
            <Formik
                ...
                validate={values => {
                    const errors = {};
                    if (!values.title) {
                        errors.title = environment.texts.nameRequired;
                    } else if (
                        !/^[a-zA-Z0-9\s]+$/i.test(values.title)
                    ) {
                        errors.title = environment.texts.validName;
                    }
                    return errors;
                }}
                        ...
                        <div className="login-form bg-white mt-4 p-4">
                            <Form className="row g-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <Field type="number" name="totalPage" className="form-control" />
                                    <ErrorMessage name="totalPage" component="div" className="text-danger" />
                                </div>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="stockActual">Actual Stock</label>
                                    <Field type="number" name="stockActual" className="form-control" />
